...
class SearchSettings(NestedChainMap):
    ...
    def initialise_env_dict(self):
        ...
        for key in self.all_keys():
            try:
                ...
                value = os.getenv(f"{SETTINGS_KEY}{self.nesting_separator}{key}")
    ...
    def initialise_db_dict(self):
        # TODO: Review/cleanup this approach to making psycopg2 optional.
        possible_exceptions = (ProgrammingError,)
        try:
            from psycopg2.errors import UndefinedTable

            possible_exceptions += (UndefinedTable,)
        except ImportError:
            ...
...
wagtail_extended_search_settings = settings_singleton.to_dict()
