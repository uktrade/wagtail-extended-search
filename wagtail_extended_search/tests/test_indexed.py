...
#     AbstractIndexedModel, AbstractModel, ChildModel, IndexedModel,
#     InheritedStandardIndexedModel, InheritedStandardIndexedModelWithChanges,
#     InheritedStandardIndexedModelWithChangesWithScoreFunction, Model,
#     StandardIndexedModel, StandardIndexedModelWithScoreFunction,
...
#             "wagtail_extended_search.index.apps.get_models",
#             return_value=[
#                 mock_model_1,
#                 mock_model_2,
#                 mock_model_3,
