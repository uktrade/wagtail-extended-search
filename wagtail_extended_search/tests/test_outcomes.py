...
from wagtail_extended_search.index import DWIndexedField as IndexedField
from wagtail_extended_search.models import Setting
from wagtail_extended_search.settings import SearchSettings, settings_singleton

# TODO: Re-write the commented out tests!
